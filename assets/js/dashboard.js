$(document).ready(function () {
  ...
  allFilesItems.forEach((item) => {
    item.addEventListener('click', () => {
      if (allFilesWrapper) {  // Add null check
  ...
  document.addEventListener('click', (e) => {
    if (allFilesWrapper && !allFilesWrapper.contains(e.target) &&
        !allFilesUploadBtn.contains(e.target)) {  // Check if click is outside both wrapper and button
      allFilesWrapper.classList.remove('show');
    }
  });
